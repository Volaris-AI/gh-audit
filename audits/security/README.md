...
**Gather Context**
- Review this documentation at `docs/audits/security/README.md`
- Select appropriate templates from `docs/audits/security/templates/`
...
**Record Findings**
- Use templates from `docs/audits/security/templates/`
...
**Store Results**
- Save completed audit reports to `docs/audits/security/`
...
Use the templates in `docs/audits/security/templates/` to structure your audit work:
...
cat docs/audits/security/README.md

# 3. Copy audit templates
cp docs/audits/security/templates/audit-checklist.md docs/audits/security/2024-02-01-myproject-audit.md
...
# 7. Store results
git add docs/audits/security/2024-02-01-myproject-audit.md
